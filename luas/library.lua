...
local library = {
    ...
    folders = {
        main = "sipare",
        assets = "sipare/Images",
        configs = "sipare/Configs"
    },
    shared = {
        initialized = false,
        fps = 0,
...
do
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://raw.githubusercontent.com/portallol/luna/main/modules/gradient90.png")
            --
            library.began[#library.began + 1] = function(Input)
